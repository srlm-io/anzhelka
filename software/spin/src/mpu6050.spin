...
PUB TestMPU  | MPUcog
 '-----------------------------------------------
  ...
  '------------------------------------------------
  debug.start(SERIAL_RX_PIN, SERIAL_TX_PIN, 0, 57600) 'Start cog to allow IO with serial terminal
...
MPUReadValues
                        ...
                        mov     i2cDevID, #%11010010    ' Device ID of the MPU 
...
:MPUSetConfig           mov     i2cDevID, #%11010010     'Device ID for the MPU-6000/6050 
