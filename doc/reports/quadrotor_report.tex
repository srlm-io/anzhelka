...
%% S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3
\subsubsection{Frame}
The frame is constucted out of a material called Derilin made by DuPont\texttrademark
%% S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3 S3
...
Our test can measure thrust and torque simultaneously and automatically. To do this we are using the Flexiforce pressure sensors \textcolor{red}{([REFERENCE])}. These sensors vary the resistance based on the amount of pressure, and resistance is very easy to measure with a microcontroller.

For motor speed we will be using a Eagle Tree brushless RPM sensors \textcolor{red}{([REFERENCE])}. Our main control board is the quadpower board that we have developed for our quadrotor. This has the advantage of being identical to what we will be flying, it will have the motor current and voltage sensing built in.
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2  
...
Finish all electrial wirring for the quadrotor
...
Since the members of this project are so financially invested into it, we plan on contuining this project for a very long time. It is quite possiable that we may even turn this project into company/business.
...
With the right funding we could add things like object advoidance, quadrotor acrobatics, and user generated ideas.
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2  
