...
Please see the attached QuadRotor Mathematics document for our supporting Materials.
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 
...
We had to learn serveral popular industry standards so that we could use them in our project. Here is a list of the standards that were used.
\begin{list}{*}{}
	\item FAT
	\item I2C
	\item RISC
	...
	\item GPS
\end{list}
Those were the industry standards that we used. More standards than these were used, but they were not idustry standards.
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2  
