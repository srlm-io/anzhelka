...
\textcolor{blue}{Cody, Not necessary though.} 
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2  
...
\textcolor{red}{This section describes issues that need to be addressed or resolved prior or while completing the desgn as well as issues that may influence the design process.}
%% S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1 S1  
...
%% S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2 S2  
\subsection{Safety}
When dealing with any autonomous system one must take extreme cautions in order to \textcolor{red}{ensure} the safety of everyone. Autonomous systems are dangerous because there is no one behind the controls of the system and can become unpredictable in the event of a system failure. \\ \\ 
