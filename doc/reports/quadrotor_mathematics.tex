...
With equation \eqref{eq:thrust_to_Omega} we have an equation that will tie the thrust required to how fast the rotors must spin. This can later be fed into a PI controller for each motor, described in -----SECTION CITATION----.
...
\begin{list}{*}{}
	...
	\item Add information about calculating "linear regression" to calculate motor constants from test date.
